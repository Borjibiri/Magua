 ...
 */
final class Version20241119124630 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD user_id_id INT DEFAULT NULL, ADD date_created DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP user_id_id, DROP date_created');
    }
}
